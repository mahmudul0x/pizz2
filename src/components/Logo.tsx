  ...
  return (
    <div className={`flex items-center gap-2 ${className}`}>
      <div className="relative grid h-9 w-9 place-items-center rounded-lg bg-gradient-gold shadow-gold">
        <span className="font-display text-xl font-black text-ink">P</span>
        <span className="absolute -right-1 -bottom-1 grid h-5 w-5 place-items-center rounded-md bg-ink ring-1 ring-[#FFC300]">
